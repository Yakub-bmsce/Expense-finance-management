...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    setTimeout(() => {
      handleDemoLogin(); // For testing, Google OAuth redirects to Demo
        ...
        <GlassCard>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label htmlFor="password" className="text-sm font-medium text-slate-300 select-none">
                  Password
                </label>
                <Link
                  to="/forgot-password"
                  className="text-xs text-brandIndigo hover:underline focus:outline-none"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="relative my-6 select-none">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#111120] px-2 text-slate-500">Or continue with</span>
            </div>
          </div>
